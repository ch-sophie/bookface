...
export default function Create() {
  ...
  return (
    ...
    <Avatar sx={{ m: 1, bgcolor: 'secondary.main' }}>
      ...
      {/* <h3 className="m-5 text-white fw-bold">Register</h3> */}
      ...
      <Box component="form" noValidate onSubmit={handleSubmit} sx={{ mt: 3 }}>
        ...
        <Button
              ...
              value="Register"
            >
            {/* <a href="/signIn" class="cancel">Cancel</a> */}
            Sign Up
        </Button>
        ...
        {/* <div className="form-group mx-5">
          <input type="submit" value="Register" className="btn buttonform" />
          <a href="/signIn" class="cancel" className="btn buttonform">Cancel</a>
        </div> */}
      {/* </form> */}
    {/* </div> */}
